  ...
  return (
    <div className="jumbotron d-flex align-items-center" id="home">
      ...
      <div className="container">
        <h1 className="display-3">Welcome to Front End Developer Skills Test 02</h1>
        ...
        <p>
          <a className="btn btn-home-learn btn-lg mr-2" href="/learn" role="button">Learn »</a>
          <a className="btn btn-home-inc btn-lg" href="/incubators" role="button">Incubators »</a>
        </p>
      </div>
